...
class PostgresMemoryFabric:
    ...
    Files remain the source of truth. PostgreSQL stores bounded metadata, searchable
    text, relationships and references to successful Operations/Receipts.
    """
        ...
        with self._connect() as connection:
            ...
            if row is None:
                ...
                row = connection.execute(
                    ...
                    (value, workspace_id, actor, title),
                ).fetchone()
        ...
        for root_value in roots:
            ...
            for current, directories, filenames in os.walk(root):
                ...
                for filename in filenames:
                    if indexed >= maximum:
                        return {"workspace_id": workspace_id, "indexed": indexed, "skipped": skipped, "truncated": True}
                    ...
                    if value:
                        ...
                        skipped += 1
        return {"workspace_id": workspace_id, "indexed": indexed, "skipped": skipped, "truncated": False}
        ...
        with self._connect() as connection:
            ...
            locators = connection.execute(
                """SELECT id,kind,canonical_value,display_value,label,metadata,last_used_at,use_count
                   ...
                   ORDER BY last_used_at DESC NULLS LAST,use_count DESC LIMIT 20""",
                (workspace_id,),
            ).fetchall()
        return {
            "available": True,
